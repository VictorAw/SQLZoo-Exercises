...
#         WHERE
#           name = 'Julie Andrews'
#         ) AS jmovies ON movies.id = jmovies.title
#     WHERE
#       castings.ord = 1
#   SQL
# end
...
def colleagues_of_garfunkel
  ...
  execute(<<-SQL)
    ...
    FROM
      ...
      INNER JOIN
        castings AS c_castings ON c_castings.movie_id = movies.id
      INNER JOIN
        actors AS colleagues ON colleagues.id = c_castings.actor_id
    WHERE
      actors.name = 'Art Garfunkel' AND colleagues.name != 'Art Garfunkel'
  SQL
end
